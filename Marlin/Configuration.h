...
#define CUSTOM_MACHINE_NAME "i3 prusa rework by frma"
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -11.4  // Z probe to nozzle Z offset: -below (always!)
...
#define HOMING_FEEDRATE {6000, 6000, 4*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,600}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3.3, 25}    // (mm/sec)
